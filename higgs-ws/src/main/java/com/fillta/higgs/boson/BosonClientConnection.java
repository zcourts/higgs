...
import com.fillta.functional.Function2;
import com.fillta.higgs.HiggsClient;
import com.fillta.higgs.HiggsInitializer;
import com.fillta.higgs.HiggsSingleMessageClientConnection;
import com.fillta.higgs.events.ChannelMessage;
import com.google.common.base.Optional;
import io.netty.buffer.ByteBuf;

public class BosonClientConnection extends HiggsSingleMessageClientConnection<String, BosonMessage, ByteBuf> {
	public BosonClientConnection(final HiggsClient<String, BosonMessage, BosonMessage, ByteBuf> client, String serviceName, String host, int port, boolean decompress, boolean useSSL, HiggsInitializer initializer) {
	...
	public void invokeF(final String method, Object[] arguments, final Function1<ChannelMessage<BosonMessage>> function,
		...
		getClient().listen(callback, new Function1<ChannelMessage<BosonMessage>>() {
			public void apply(ChannelMessage<BosonMessage> a) {
				if (unsubscribe) {
					getClient().unsubscribe(method, this);
				}
				function.apply(a);
			}
		});
	 ...
	 * @param <R>
	 */
	public <R> void invokeSubscribe(final String method, Object[] arguments, final Function1<R> function) {
	 ...
	 */
	public <R> void invoke(final String method, Object[] arguments, final Function2<R, Optional<? extends Throwable>> function, boolean unsubscribe) {
	...
	/**
	 * A proxy to {@link #invoke(String, Object[], com.fillta.functional.Function1)}
	 */
	...
	/**
	 * A proxy to {@link #invoke(String, Object[], com.fillta.functional.Function2, boolean)}
	 */
	...
	public <R> void invoke(final String method, Object[] arguments, final Function2<R, Optional<? extends Throwable>> function) {
		invoke(method, arguments, function, true);
	}
}