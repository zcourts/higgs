...
public class JsonRequest implements JsonRequestEvent {
	...
	public boolean equals(final Object o) {
		...
		if (callback != null ? !callback.equals(request.callback) : request.callback != null) return false;
		if (message != null ? !message.equals(request.message) : request.message != null) return false;
		if (topic != null ? !topic.equals(request.topic) : request.topic != null) return false;
