...
public class WebSocketInterceptor implements HiggsInterceptor {
    ...
    public static final AttributeKey<WebSocketServerHandshaker> attHandshaker = new AttributeKey<>("handshaker");
    private final WebSocketServer<? extends JsonRequestEvent> server;
    private final Logger log = LoggerFactory.getLogger(getClass());

    public WebSocketInterceptor(WebSocketServer<? extends JsonRequestEvent> server) {
        this.server = server;
    }
     ...
     *
     * @param path the path to listen for web socket requests on
     */
