...
public class OAuth1Conf {
	...
	protected void createRequest() {
		...
		if (scope != null) request.addOAuthParameter(OAuthConstants.SCOPE, scope);
		String baseString = api.getBaseStringExtractor().extract(request);
		String signature = api.getSignatureService().getSignature(baseString, apiSecret, OAuthConstants.EMPTY_TOKEN.getSecret());
