...
public class HttpMessageConverter {
	public final static AttributeKey<String> attTopic = new AttributeKey("http-message-converter-topic");
	public final static AttributeKey<HTTPResponse> attResponse = new AttributeKey("http-message-converter-response");
	public final static AttributeKey<Boolean> attSeen = new AttributeKey("http-message-converter-seen-request");
	...
	public HTTPResponse deserialize(ChannelHandlerContext ctx, Object msg) {
		...
		if (seen) //don't trigger callback again if we've seen this response before
			return null;
		return response;
	}
