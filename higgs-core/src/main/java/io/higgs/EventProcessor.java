...
public abstract class EventProcessor<T, OM, IM, SM> extends ChannelInboundMessageHandlerAdapter<SM> {
     ...
     * and triggers a normal {@link io.higgs.events.HiggsEvent}.EXCEPTION_CAUGHT.
     ...
     * By default this uses {@link io.higgs.queueingStrategies.SameThreadQueueingStrategy} which will
    ...
    /**
     * Set the queueing strategy to use a {@link io.higgs.buffer.CircularBuffer}
     */
    @SuppressWarnings("UnusedDeclaration")
